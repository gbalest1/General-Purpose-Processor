...
<drawing version="7">
    ...
    <netlist>
        ...
        <blockdef name="Instruction_Decoder">
            <timestamp>2013-3-4T5:49:12</timestamp>
        ...
        <block symbolname="RegParallelLoad_4" name="PROGRAM_COUNTER">
            ...
            <blockpin signalname="step" name="load" />
        ...
        <block symbolname="and2b1" name="XLXI_51">
            <blockpin signalname="Instruction(7)" name="I0" />
        ...
        <block symbolname="and2" name="XLXI_49">
            <blockpin signalname="step" name="I0" />
            <blockpin signalname="capture_Z" name="I1" />
            <blockpin signalname="XLXN_137" name="O" />
        </block>
        <block symbolname="and2" name="XLXI_50">
            <blockpin signalname="step" name="I0" />
            <blockpin signalname="capture_N" name="I1" />
    ...
    <sheet sheetnum="3" width="3520" height="2720">
        ...
        <instance x="2704" y="416" name="XLXI_48" orien="R0" />
        <branch name="step">
            <wire x2="2704" y1="352" y2="352" x1="2656" />
        </branch>
        <branch name="step">
            <wire x2="2704" y1="528" y2="528" x1="2656" />
        </branch>
        <branch name="step">
            <wire x2="2704" y1="704" y2="704" x1="2656" />
        </branch>
        ...
        <iomarker fontsize="28" x="2656" y="352" name="step" orien="R180" />
        <iomarker fontsize="28" x="2656" y="528" name="step" orien="R180" />
        <iomarker fontsize="28" x="2656" y="704" name="step" orien="R180" />
        ...
        <iomarker fontsize="28" x="816" y="1568" name="step" orien="R180" />
        ...
        <branch name="step">
            ...
            <wire x2="864" y1="1504" y2="1520" x1="864" />
            <wire x2="864" y1="1520" y2="1568" x1="864" />
        </branch>
        ...
        <instance x="1360" y="704" name="XLXI_51" orien="R0" />
        ...
        <branch name="step">
            ...
            <wire x2="1360" y1="576" y2="576" x1="1312" />
        </branch>
        ...
        <instance x="2704" y="592" name="XLXI_49" orien="R0" />
        <instance x="2704" y="768" name="XLXI_50" orien="R0" />
        <branch name="capture_C">
